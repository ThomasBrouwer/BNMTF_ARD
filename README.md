...
![bnmf](./images/gm_bnmf.png "Graphical model of Bayesian nonnegative matrix factorisation.")
![bnmtf](./images/gm_bnmtf.png "Graphical model of Bayesian nonnegative matrix tri-factorisation.")

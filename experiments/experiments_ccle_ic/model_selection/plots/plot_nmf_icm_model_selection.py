...
plot_file = folder_plots+"nmf_icm_model_selection.png"

colour = 'g' #['r','b','g','c'] -> VB, Gibbs, ICM, NP


''' Load in the performances. '''
gibbs_performances = eval(open(folder_results+'nmf_icm.txt','r').read())
gibbs_ard_performances = eval(open(folder_results+'nmf_icm_ard.txt','r').read())

"""
Recover the CCLE EC50 dataset using ICM. We use K,L=5,5.
...
output_folder = project_location+"BNMTF_ARD/experiments/experiments_ccle_ec/convergence_average/results/"
output_file_performances = output_folder+'nmtf_icm_all_performances.txt'
output_file_times = output_folder+'nmtf_icm_all_times.txt'
...
for i in range(0,repeats):
    ...
    # Run the classifier
    BNMTF = nmtf_icm(R,M,K,L,ARD,hyperparams) 

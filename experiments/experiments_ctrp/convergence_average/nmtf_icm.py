"""
Recover the CTRP EC50 dataset using ICM. We use K,L=5,5.
...
output_folder = project_location+"BNMTF_ARD/experiments/experiments_ctrp/convergence_average/results/"

"""
Plot the performances of NMTF VB for different hyperparameter values, for 
...
plot_file = folder_plots+"nmtf_vb_hyperparameter.png"


''' Load in the performances. '''
performances = eval(open(folder_results+'nmtf_vb.txt','r').read())
